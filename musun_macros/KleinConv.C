...
void KleinConv(int run=32541, int channel=7, double sigma=60., double channelKE=4100., double binKE=218., double back=5.)
...

{
  ...
  TFile *_file0 = TFile::Open("rawHist.root");    
  TH1D *h1 = (TH1D*)_file0->Get("hNeutronHist");
